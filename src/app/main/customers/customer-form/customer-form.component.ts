...
export class CustomerFormComponent implements OnInit {
  ...
  onSubmit(){
    ...
    if (this.f.id.value) {
      ...
      this.customerService.updateCustomer(this.customerForm.getRawValue()).pipe(takeUntil(this.unsubscribeAll)).subscribe((response) => {
      ...
      this.blockUI.start();
      this.customerService.insertCustomer(this.customerForm.getRawValue()).pipe(takeUntil(this.unsubscribeAll)).subscribe((response) => {
        this.router.navigate(['/customers']);
        this.blockUI.stop();
      }, () => {
        // error
